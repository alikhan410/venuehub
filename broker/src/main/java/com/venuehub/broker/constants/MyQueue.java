...
public enum MyQueue {
    ...
    public static class Constants {
        ...
        public static final String VENUE_CREATED_QUEUE_IMAGE_SERVICE = "VENUE_CREATED_QUEUE_IMAGE_SERVICE";
        public static final String VENUE_DELETED_QUEUE_IMAGE_SERVICE = "VENUE_CREATED_QUEUE_IMAGE_SERVICE";
        public static final String VENUE_UPDATED_QUEUE_IMAGE_SERVICE = "VENUE_CREATED_QUEUE_IMAGE_SERVICE";
        ...
        public static final String IMAGE_CREATED_QUEUE_VENUE_SERVICE = "IMAGE_CREATED_QUEUE_VENUE_SERVICE";
